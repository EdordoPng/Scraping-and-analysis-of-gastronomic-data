...
# Uguale a quella di prima solo che fa l'analisi considerando non la prima parola, ma la prima parola senza l'ultimo carattere
...
def main():
    ...
    print(f"Totale ingredienti Planeat  : {len(ingredienti_planeat)}")
    print(f"Totale ingredienti DIssapore  : {len(ingredienti_dissapore)}")
    ...
    print("Inizio salvataggio file complete_fuzzy2.csv")
